...
static FILE *writeZippedFile(char *fileName, flag append) {
  ...
  if (n < 0 || n >= (int)sizeof(buf)) {
    error("Command string truncated in writeZippedFile");
    return NULL;
  }
